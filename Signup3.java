...
public class  Signup3 extends JFrame implements ActionListener {
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,ll0,lll,ll2;
    ...
    Signup3(String formno){
        ...
        ll0= new JLabel("Services Required ");
        ll0.setFont(new Font("Raleway",Font.BOLD,18));
        
        lll= new JLabel("Form No: ");
        lll.setFont(new Font("Raleway",Font.BOLD,13));
        
        ll2= new JLabel(formno);
        ll2.setFont(new Font("Raleway",Font.BOLD,13));
        ...
        c7 =new JCheckBox("I herby declares that the above enterd details correct to the best of my knowledge.",true);
        ...
        lll.setBounds(700,10,70,30);
        add(lll);
        
        ll2.setBounds(770, 40, 400, 80);
       add(ll2);
     ...
     public void actionPerformed(ActionEvent ae){
         ...
         if(r1.isSelected()){
          ...
          if(c4.isSelected()){
              facility= facility+"Email Address";
          }
          if(c5.isSelected()){
